...
/**
 * COMMENT: Comment Triangle and an annulus with VBOs
 *
 * 
 */
public class SceneNoVAO implements GLEventListener {
	 ...
	 //These are not VBOs, just java containers.
	 ...
	 //Triangle and annulus both have 2 each.
	 //One for vertex data and one for indexes
    ...
    public void init(GLAutoDrawable drawable) {
         ...
         //First buffer for triangle vertex data
         ...
         //Second buffer for triangle indexes
    ...
    public static void main(String[] args) {
        ...
        SceneNoVAO triangle = new SceneNoVAO();
